...
def detail_page():
    ...
    try:
        ...
        return render_template('detail.html', team_name=team_name, hometown=hometown, home_stadium=home_stadium,
                               team_manager=team_manager, players=players, numbers=numbers, zip=zip)
...
def home():
    ...
    for team in teams:
        teamname = team.select_one(
            'td.widget-match-standings__team > a.widget-match-standings__link > span').text  # 팀이름
